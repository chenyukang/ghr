const shortcuts = [
  ...
  ["General", "Tab / Shift+Tab", "Move within the focused tab group"],
  ...
  ["List", "[ / ]", "Move list selection by a visible page"],
  ["List", "PgUp / PgDown or u / d", "Also move by a visible page"],
  ["List", "Alt+[ / Alt+]", "Load previous or next GitHub result page"],
  ...
  ["Diff", "q", "Return to the state before opening diff mode"],
  ...
  ["Diff Details", "single click", "Begin or move a review range"],
  ["Diff Details", "double click", "End a review range"],
