const shortcuts = [
  ...
  ["List", "Shift+Tab", "Switch to the previous Section, then return to List after 400 ms"],
  ["List", "Shift+[ / Shift+]", "Switch to the left or right Section, then return to List after 400 ms"],
