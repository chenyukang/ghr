const shortcuts = [
  ["General", ":", "Open the command palette and fuzzy-search commands; recent commands lead before typing, then relevance wins"],
  ...
  ["General", "Tab / Shift+Tab", "Switch focus or move within focused ghr/Sections tabs"],
  ["General", "h / l / [ / ]", "Move within focused ghr or Sections tabs"],
  ["General", "j / k / n / p / Up / Down", "Move focus between ghr, Sections, and List"],
  ["General", "S", "Search pull requests and issues with structured fields; global lists include Repo, repo tabs stay repo-scoped, and Inbox searches by state, reason, and repo"],
  ["General", "f", "Filter the current PR, issue, or inbox section"],
  ...
  ["List", "Tab", "Focus the Details pane"],
  ["List", "Shift+Tab", "Switch to the previous Section, then return to List after 200 ms"],
  ...
  ["Details", "n / p", "Focus checks and comments; p moves back toward PR/issue details"],
  ["Details", "Enter", "Open a focused check, or expand/collapse a long focused comment"],
